...
async def list_notices(
    ...
    result = await ListNoticesUseCase(db).execute(page, size)
    items = [{"id": n.id, "title": n.title, "content": n.content, "is_pinned": n.is_pinned, "created_at": n.created_at} for n in result.items]
